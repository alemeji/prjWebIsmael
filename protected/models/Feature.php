...
class Feature extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'categories' => array(self::MANY_MANY, 'Category', 'featurexcategory(id_feature, id_category)'),
			'itemxcategoryxfeatures' => array(self::HAS_MANY, 'Itemxcategoryxfeature', 'id_feature'),
		);
	}
